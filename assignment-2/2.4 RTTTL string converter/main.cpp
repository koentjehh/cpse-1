...
// maakt file melody.cpp aan (melody_file globaal)
std::ofstream melody_file;
...
int main( void ){
	...
	melody_file.open( "melody.cpp" ); 
	melody_file << "#include \"melody.hpp\" \n\n"
				<< "void melody::play( note_player & p ){ \n";   
				
	auto p = note_print(); // voeg noten toe aan melody.cpp
